    ...
    <body>
        ...
        <%
              int id= Integer.parseInt(request.getParameter("catid"));
               List<Post> post = PostDao.getAllPostByCatId(id);
              String catname = CategoryDao.categoryName(id);
        ...
        <main>
            ...
            <%
               if(post.size()==0)
               {
                ...
                <h1 style="text-align: center; padding: 20px;">No Blog Found in the <%= catname %> category</h1>
                
               <% } else { %> 
            
            <h1 style="text-align: center; padding: 20px;"><%= catname +" Category" %></h1>
            <div class="blogs">
